...
"Current version number is " + $csprojcontents.Project.PropertyGroup[1].FileVersion
$oldversionNumber = $csprojcontents.Project.PropertyGroup.FileVersion
$csprojcontents.Project.PropertyGroup[1].FileVersion = ${build_number}
$csprojcontents.Project.PropertyGroup[1].AssemblyVersion = ${build_number}
